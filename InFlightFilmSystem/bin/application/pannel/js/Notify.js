...
var Notify = function(options) {
  ...
  this.gethtml = function() {
    var strVar = "";
    strVar += "<div class=\"alert alert-" + this.status + " alert-dismissable text-noselect\" id=\"msg" + this.id + "\" style='height:100%;font-size:2em;z-index:999;'>\n";
    strVar += "	<button id=\"msg_close" + this.id + "\" type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\" tabindex=\"0\">\n";
    strVar += "                &times;\n";
    strVar += "	<\/button>\n";
    strVar += this.text;
    strVar += "<\/div>\n";
